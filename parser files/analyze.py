...
def analyze(freqListFile, paradigmFile, lexFile, lexRulesFile,
            ...
            minFlexLen=3, maxCompileTime=60):
    t1 = time.clock()
...
if __name__ == '__main__':
    ...
    analyze(freqListFile, paradigmFile, lexFile, lexRulesFile, derivFile, conversionFile,
            cliticFile, delAnaFile, parsedFile, unparsedFile, errorFile,
            xmlOutput=xmlOutput, parserVerbosity=parserVerbosity,
            freqListSeparator=freqListSeparator, parsingMethod=parsingMethod)
