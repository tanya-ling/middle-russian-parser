...
class Inflexion:
    ...
    def __init__(self, dictDescr, errorHandler=None):
        ...
        self.stemNumOut = None  # what stem the subsequent inflexions
        ...
        while self.continue_compilation(depth, startTime):
            ...
            for f in self.flex:
                ...
                if (g.PARTIAL_COMPILE and
                        (f.get_length() >= g.MIN_FLEX_LENGTH or
                    ...
                    # print('EXTEND:\n', f, '\n'+'\nand\n'.join(str(fe) for fe in newFlexExtensions))
